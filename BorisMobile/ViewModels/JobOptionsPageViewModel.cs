...
namespace BorisMobile.ViewModels
{
    ...
    {
        public async void HandleJob(string xmlElement, WorkOrderList workOrder,AuditsInProgress inProgress)
        {
            ...
            //if (true)
            //{
                 await App.Current.MainPage.Navigation.PushAsync(new JobFormPage(xmlElement,workOrder, inProgress));
            //}
            //else
            //{
