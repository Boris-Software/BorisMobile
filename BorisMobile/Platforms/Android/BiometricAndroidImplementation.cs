...
{
    public class BiometricAndroidImplementation : IBiometricService
    {
        ...
        //    {
        //        if (AndroidX.Core.Content.ContextCompat.CheckSelfPermission(context, Manifest.Permission.UseBiometric)
